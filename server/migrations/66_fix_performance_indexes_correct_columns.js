...
module.exports = {
  up: async (queryInterface) => {
    ...
    await createIndexSafely('rice_stock_movements', 'idx_rice_stock_from_v2', ['from']);
    await createIndexSafely('rice_stock_movements', 'idx_rice_stock_to_v2', ['to']);
    ...
    await createIndexSafely('outturns', 'idx_outturns_kunchinittu_v2', ['kunchinittu_id']);
    ...
    await createIndexSafely('opening_balances', 'idx_opening_bal_type_v2', ['balance_type']);
    await createIndexSafely('opening_balances', 'idx_opening_bal_date_type_v2', ['date', 'balance_type']);
